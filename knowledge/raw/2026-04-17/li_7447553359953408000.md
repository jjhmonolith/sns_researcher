...
crawled_at: '2026-04-17T17:15:47.276304'
novelty_reason: 해커톤→커뮤니티→사례 축적→문화로 이어지는 AX 운영 프레임과 context/harness engineering 같은
  실무 용어를 제시하지만, 기업명·정량 성과가 제한적이라 검증 가능한 새 데이터는 부족합니다.
novelty_score: 62
...
relevance_score: 62
topics:
- AI Transformation(AX) 문화/거버넌스
- 생성형 AI 기반 업무 프로세스 혁신
- AI 에이전트 활용(해커톤 룰/커뮤니티)
- Context Engineering & Harness Engineering
- AI 시대의 생산비 절감과 경쟁 구도 변화
url: https://www.linkedin.com/feed/update/urn:li:activity:7447553359953408000/
---

# Goobong Jeong: AI로 생산비가 급락하고 미래가 빨리 고정되는 환경에서, 해커톤과 커뮤니티로 사례를 빠르게 만들고 이를 문화로 정착시키는 것이 AX의 본질이라고 주장합니다. 또한 write를 넘어 context engineering과 실행을 위한 harness engineering을 강조합니다.

**AI 요약**: AI로 생산비가 급락하고 미래가 빨리 고정되는 환경에서, 해커톤과 커뮤니티로 사례를 빠르게 만들고 이를 문화로 정착시키는 것이 AX의 본질이라고 주장합니다. 또한 write를 넘어 context engineering과 실행을 위한 harness engineering을 강조합니다.

**게시일**: 2026-04-10

**참신성 점수**: 62/100

**참신성 이유**: 해커톤→커뮤니티→사례 축적→문화로 이어지는 AX 운영 프레임과 context/harness engineering 같은 실무 용어를 제시하지만, 기업명·정량 성과가 제한적이라 검증 가능한 새 데이터는 부족합니다.

**토픽**: AI Transformation(AX) 문화/거버넌스, 생성형 AI 기반 업무 프로세스 혁신, AI 에이전트 활용(해커톤 룰/커뮤니티), Context Engineering & Harness Engineering, AI 시대의 생산비 절감과 경쟁 구도 변화
